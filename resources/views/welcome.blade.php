...
<head>
  ...
  <title>SocialSuite — Phase 1</title>
  ...
  <style>
    ...
    .card { background:#111827; border:1px solid #1f2937; border-radius:16px; padding:32px; max-width:560px; width:100%; box-shadow:0 10px 30px rgba(0,0,0,.3); }
...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <h1 class="title">SocialSuite — Nền tảng sạch</h1>
      <p class="muted">Kiến trúc DB & UI tối giản. OAuth Facebook sẽ bật ở Phase 2.</p>
